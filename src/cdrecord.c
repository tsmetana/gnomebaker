...
void cdrecord_pre_proc(void *ex, void *buffer);
void cdrecord_blank_pre_proc(void *ex, void *buffer);
void cdrecord_blank_post_proc(void *ex, void *buffer);
void cdrecord_add_common_args(ExecCmd * const cdBurn);
